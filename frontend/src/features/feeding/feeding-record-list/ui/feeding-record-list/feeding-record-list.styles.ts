export const feedingRecordListStyles = {
  list: 'flex flex-col gap-3',
  state: 'py-4',
  card: 'rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-800',
  cardHeader: 'flex items-center justify-between gap-2 mb-1',
  cardFood: 'text-sm font-medium text-zinc-900 dark:text-zinc-50',
  cardActions: 'flex items-center gap-2',
  cardDate: 'text-xs text-zinc-500 dark:text-zinc-400',
  cardQuantity: 'text-sm text-zinc-600 dark:text-zinc-300',
  cardNotes: 'text-xs text-zinc-400 dark:text-zinc-500 mt-1',
